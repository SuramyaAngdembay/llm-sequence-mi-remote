...
OUTPUT_DIR="${OUTPUT_DIR:-/anvil/projects/x-cis230270/x-sangdembay/cert-qlora-MI/outputs/token_delta_sae_necessity_qwen3b/${TAG}}"
...
cat <<EOM
submitted_qwen3b_token_necessity_bundle=1
