...
submit_causal_probe() {
  ...
  MAX_CANDIDATE_DONORS="$MAX_CANDIDATE_DONORS_PROBE" \
...
MAX_CANDIDATE_DONORS_PROBE="${MAX_CANDIDATE_DONORS_PROBE:-2}"
...
MAX_CANDIDATE_DONORS_PROBE=${MAX_CANDIDATE_DONORS_PROBE}
