...
export CONTEXT_MODES TOP_SETS CONTROL_SET ACTIVE_CONTROL_MIN_FRAC ALPHAS MAX_RECEIVERS MAX_CANDIDATE_DONORS EXCLUDE_SAME_USER_DONORS GPU_POLL_SEC

SBATCH_ARGS=(--parsable --mem="$CAUSAL_MEM" --export=ALL)
