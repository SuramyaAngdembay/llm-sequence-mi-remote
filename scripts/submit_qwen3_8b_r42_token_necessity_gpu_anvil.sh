...
COMMON_OUTPUT_ROOT="${COMMON_OUTPUT_ROOT:-/anvil/projects/x-cis230270/x-sangdembay/cert-qlora-MI/outputs/token_delta_sae_necessity_qwen3_8b_r42_gpu}"
TAG="${TAG:-l26_m02_k04_top5_control5_active_necessity_gpu_bs12}"
...
echo "Submitting Qwen3-8B r4.2 token necessity on A100..."
...
cat <<EOM
submitted_qwen3_8b_r42_token_necessity_gpu=1
causal_job=${CAUSAL_JOB}
bootstrap_job=${BOOTSTRAP_JOB}
partition=${GPU_PARTITION}
account=${GPU_ACCOUNT}
