...
CHECKPOINT_ROOT="${CHECKPOINT_ROOT:-/anvil/projects/x-cis230270/x-sangdembay/cert-qlora-MI/checkpoints/qwen3_8b_session_qlora_r42_ddp_mb28_gc_on}"
TOKEN_CACHE_ROOT="${TOKEN_CACHE_ROOT:-/anvil/projects/x-cis230270/x-sangdembay/cert-qlora-MI/token_delta_cache/qwen3_8b_session_token_deltas_r42_mb28_gc_on}"
FRONTIER_ROOT="${FRONTIER_ROOT:-/anvil/projects/x-cis230270/x-sangdembay/cert-qlora-MI/outputs/token_delta_sae_frontier_qwen3_8b_r42_mb28_gc_on}"

NPROC="${NPROC:-4}"
MICRO_BS="${MICRO_BS:-28}"
