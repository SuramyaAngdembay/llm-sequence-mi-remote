...
SCORE_OUTPUT_DIR="${SCORE_OUTPUT_DIR:-/anvil/projects/x-cis230270/x-sangdembay/cert-qlora-MI/detector_score_cache/qwen3_8b_r62_fullpop_scores}"
SCORES_PARQUET="${SCORES_PARQUET:-${SCORE_OUTPUT_DIR}/example_scores.parquet}"
OUT_DIR="${OUT_DIR:-results/qwen3_8b_token_causal/detector_metrics_fold_aligned}"
RUN_NAME="${RUN_NAME:-qwen3_8b_r62_fold_aligned}"
SEED="${SEED:-42}"
...
cat <<EOM
submitted_qwen3_8b_r62_fold_aligned_detector=1
