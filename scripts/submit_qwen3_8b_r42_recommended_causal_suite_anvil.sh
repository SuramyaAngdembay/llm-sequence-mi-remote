...
COMMON_MAX_RECEIVERS="${COMMON_MAX_RECEIVERS:-0}"
COMMON_MAX_CANDIDATE_DONORS="${COMMON_MAX_CANDIDATE_DONORS:-16}"
COMMON_PATCH_CHUNK_SIZE="${COMMON_PATCH_CHUNK_SIZE:-0}"
...
run_bundle() {
  ...
  MAX_RECEIVERS="$COMMON_MAX_RECEIVERS" \
  MAX_CANDIDATE_DONORS="$COMMON_MAX_CANDIDATE_DONORS" \
...
echo "max_receivers=${COMMON_MAX_RECEIVERS}"
echo "max_candidate_donors=${COMMON_MAX_CANDIDATE_DONORS}"
echo "patch_chunk_size=${COMMON_PATCH_CHUNK_SIZE}"
echo "token_delta_dtype=${COMMON_TOKEN_DELTA_DTYPE}"
echo
