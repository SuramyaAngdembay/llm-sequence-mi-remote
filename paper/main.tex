...
features concentrate on behavioral session events such as durations. Both
attributions reproduce under dictionaries retrained on benign rows alone.
Each feature family is stable across SAE initializations, while literal
feature transfer between benchmarks fails. Critically, when malicious users are
...
dominant-user-defined feature identity. Held-out intervention effects are
...
arms. A perturbation-norm audit of the headline candidate pools shows
