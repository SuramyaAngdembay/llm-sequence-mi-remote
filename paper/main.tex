...
the shortcut. Neither factor of the two-factor account has yet been
manipulated in isolation: the classical detectors differ from the language
model in objective, representation, architecture, and capacity
simultaneously, and profile distinctiveness has not been varied
independently of malicious-user count; factorial designs (matched adapters
trained with profile fields removed, shuffled, or loss-downweighted;
distinctiveness varied at fixed count) remain the decisive tests of the
account. The account's two corners
