...
and in a smaller-scale rerun with the serialization defect repaired and
fresh adapter seeds.
...
the serialization defect or particular to the 8B run.
...
serializer, but the 8B intervention estimands themselves rest on one
adaptation run per benchmark, the rerun's \rsix{} arms train on a capped
corpus, and no intervention estimands were rerun at 3B---the 8B causal
claims remain scoped to their runs. Relatedly, the
