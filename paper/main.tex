...
predominantly behavioral features. \rsix{}'s
...
as behavior; the masking analysis in Section~\ref{sec:cross} probes whether
...
distinct headline mechanisms are not consistent with a simple feature
relabeling of one shared sparse representation, even after controlling for
depth. (r4.2's headline mechanism is itself at layer 26;
...
dictionary formation itself. \rsix{}'s
...
max-aggregation). We report these masking contrasts descriptively, without
interval estimates. On \rsix{}, all three variants remain near chance at the
day level (ROC $0.547$ original, $0.575$ no-psy, $0.471$ no-profile): with
every user unseen, profile novelty separates nothing, and no clear behavioral
signal is revealed underneath. On \rfour{}, masking
