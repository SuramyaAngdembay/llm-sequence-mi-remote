...
metadata on \rsix{}, behavior on \rfour{}. We tested the population-size hypothesis directly by malicious-population
...
showed causally real mechanisms on both; the confirmation splits showed
directional held-out replication; the seed controls showed stability across
SAE initializations. Only token-level attribution revealed that one of them detects
