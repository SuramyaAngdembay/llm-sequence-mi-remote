...
question the audit makes precise. A score-time ablation that masks profile
fields and rescores both populations with the frozen model is in progress.
% TODO(masking): insert masking numbers when Aquaman scorings complete.
