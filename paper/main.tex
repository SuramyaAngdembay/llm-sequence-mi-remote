...
effect. Malicious-population subsampling on \rfour{} shows positive-population size
alone does not explain the feature-selection dissociation, benign-only SAE
retraining shows the attribution result does not require positive-shaped
dictionaries, and score-time profile masking
...
\citep{geirhos2020shortcut}, a risk amplified when pipelines are
underspecified by their evaluations \citep{damour2020underspecification}.
...
which involves no intervention.
