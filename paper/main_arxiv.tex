...
On raw enterprise authentication logs with no injected profile (LANL), the
unseen-user collapse recurs and host identity, a user-associated field,
carries the shortcut. The score-level
...
(Section~\ref{sec:lanl}) the unseen-user collapse recurs and host identity, a
user-associated field, carries the shortcut. The resulting two-factor
...
with no injected profile (LANL; Section~\ref{sec:lanl}), shows the shortcut is
not tied to profile injection: the unseen-user collapse recurs and the identity
signal relocates to the user-associated host field. The cross-architecture
