\begin{table}[htbp]
\caption{Dictionary-independence summary. Attribution (where the selected features are active) reproduces under SAE dictionaries retrained on benign rows only, while held-out replication of the intervention estimands is estimand- and dictionary-dependent.}
