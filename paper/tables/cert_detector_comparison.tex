...
\midrule
r6.2 & Session LM (adapted NLL) & 0.0008 & \textbf{0.953} & 0.054 & 0.970 & \textbf{24.0} \\
 ...
 & \emph{Session LM, user-disjoint benign} & 0.0005 & 0.545 & 0.013 & 0.546 & -- \\
\midrule
r4.2 & Session LM (adapted NLL) & 0.0134 & \textbf{0.964} & 0.101 & 0.969 & \textbf{26.4} \\
 ...
 & \emph{Session LM, user-disjoint benign} & 0.1023 & 0.668 & 0.521 & 0.565 & -- \\
\bottomrule
\end{tabular}
\end{table}
