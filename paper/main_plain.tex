...
trained on the same information do not take the profile shortcut. The
conclusion is that high ranking performance alone does not show that a
detector has learned to detect behavior, and we provide a way to check.
\end{abstract}
...
the real-data result of Section~\ref{sec:findings}.3.
